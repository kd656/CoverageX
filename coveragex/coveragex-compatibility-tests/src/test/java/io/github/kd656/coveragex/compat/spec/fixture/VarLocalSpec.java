...
/**
 * Spec for {@code io.github.kd656.coveragex.fixtures.VarLocal}.
 *
 * <p>Migrated from the legacy {@code VarLocalContracts} utility class. Original
 * commentary and contract values preserved verbatim from the source.</p>
 */
public final class VarLocalSpec implements FixtureContractSpec {

    @Override
    public String fqn() {
        return "io.github.kd656.coveragex.fixtures.VarLocal";
    }
    ...
    public FixtureContracts contracts() {
        return FixtureContracts.builder()
                ...
                .skipArgs("sum() takes no arguments")
