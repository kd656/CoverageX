 ...
 * fully-qualified name (e.g. {@code "com.coveragex.fixtures.IfElse"}).</p>
 *
...
public final class BytecodeFixtures {
     ...
     * attribute. Returned map keys are JVM internal names (e.g. {@code "com/coveragex/fixtures/TryWithResources$AutoCloseableImpl"})
