...
<div id="invocation-popover" class="popover" style="display:none">
  ...
  <div class="inv-table-wrap">
    <table><thead><tr>
      <th>Test method</th><th style="text-align:right">Calls</th><th>Arguments</th>
...
<div id="branch-popover" class="popover" style="display:none">
  ...
  <div class="bp-tests" id="bp-tests-section">
    <div class="bpt-label">Tests that hit this direction</div>
    <div id="bp-tests-list"></div>
  </div>
</div>
</#macro>
